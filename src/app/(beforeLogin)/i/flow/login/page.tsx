...
export default function Page(){
    return (
        <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-5/12 h-3/5 box-border border-4 bg-black p-5 rounded-2xl border-black z-0'>
            <button>
